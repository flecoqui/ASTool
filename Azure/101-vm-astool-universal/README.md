# Deployment of a VM (Linux or Windows) running git and .Net Core to build and run ASTool 
...
This template allows you to deploy a single virtual machine running git and .Net core SDK version 2.1 or later. This virtual machine can run the following operating systems:
- Debian
- Ubuntu 
- Centos 
- Red Hat
