...
{
    class Mp4BoxENCA : Mp4Box
    {
  
        static public Mp4BoxENCA CreateENCABox(Int16  RefIndex, Int16 ChannelCount, Int16 SampleSize, Int32 SampleRate, List<Mp4Box> listChild)
        {

            Mp4BoxENCA box = new Mp4BoxENCA();
            if (box != null)
            {
                int ChildLen = 0;
                if (listChild != null)
