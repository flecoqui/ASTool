...
{
    class Mp4BoxAVC1 : Mp4Box
    {
  
        static public Mp4BoxAVC1 CreateAVC1Box(Int16  RefIndex, Int16 Width, Int16 Height, Int16 HorizontalRes, Int16 VerticalRes, Int16 FrameCount, Int16 Depth, List<Mp4Box> listChild)
        {

            Mp4BoxAVC1 box = new Mp4BoxAVC1();
            if (box != null)
            {
                int ChildLen = 0;
                if (listChild != null)
