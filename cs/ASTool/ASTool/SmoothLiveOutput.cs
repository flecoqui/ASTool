    ...
    public class SmoothLiveOutput:  ManifestOutput 
    {
        ...
        bool SendBuffer(Stream stm, byte[] buffer, string source)
        {
            ...
            while (offset < buffer.Length)
            {
                ...
                SendBox(stm, ISMHelper.Mp4Box.ReadMp4BoxBytes(buffer, offset, BoxLen));
                offset += BoxLen;
                                ...
                                if(spm.NetworkStream!=null)
                                {
                                    ...
                                    if (sb != null)
                                    {
                                        ...
                                        if (IsResponseOk(spm.NetworkStream) == true)
                                        {
                                            ...
                                            SendBox(spm.NetworkStream, cl.ftypData);
                                            ...
                                            if (ac != null)
                                            {
                                                       ...
                                                       0) > 0)
                                                {
                                                    ...
                                                    SendBox(spm.NetworkStream, buffer);
                                                }
                                            }
                                            ...
                                            Console.WriteLine("Source " + cl.Configuration.GetSourceName() + " Streaming MP4 Box " + BoxType + " " + BoxLen.ToString() + " Bytes");
                                            SendBox(spm.NetworkStream, cl.moovData);

                                            // Sending the other boxes
                                            SendAudioLoop(spm.NetworkStream, cl, cache);
                                        }
                                    }
                                }
                            }
                                ...
                                if (spm.NetworkStream != null)
                                {
                                    ...
                                    if (sb != null)
                                    {
                                        ...
                                        if (IsResponseOk(spm.NetworkStream) == true)
                                        {
                                            ...
                                            // Sending the other boxes
                                            SendVideoLoop(spm.NetworkStream, cl, cache);
                                        }
                                    }
                                }
                            }
